CREATE TRIGGER trigger_after_update_gokabam_api_data_elements
  ...
  BEGIN
    ...
    if NEW.is_deleted = 0 THEN
      ...
      VALUES (NEW.object_id,NEW.last_page_load_id,'edit',@has_tags_changed,@has_words_changed,@has_objects_changed);
    ELSE
      INSERT INTO gokabam_api_change_log(target_object_id,page_load_id,edit_action,is_tags,is_words,is_element_objects)
      VALUES (NEW.object_id,NEW.last_page_load_id,'delete',@has_tags_changed,@has_words_changed,@has_objects_changed);
    END IF;
