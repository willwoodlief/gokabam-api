CREATE TRIGGER trigger_after_update_gokabam_api_use_case_parts
  ...
  BEGIN
    ...
    if NEW.is_deleted = 0 THEN
      ...
      VALUES (NEW.object_id,OLD.last_page_load_id,'edit',@has_tags_changed,@has_words_changed,@has_groups_changed,@has_api_changed,@has_sql_changed,@has_connection_changed,@has_journals_changed);
    ELSE
      INSERT INTO gokabam_api_change_log(target_object_id,page_load_id,edit_action,is_tags,is_words,is_groups,is_apis,is_sql_parts,is_use_case_part_connection,is_journals)
      VALUES (NEW.object_id,OLD.last_page_load_id,'delete',@has_tags_changed,@has_words_changed,@has_groups_changed,@has_api_changed,@has_sql_changed,@has_connection_changed,@has_journals_changed);
    END IF;
